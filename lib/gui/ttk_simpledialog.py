# original file edited to use ttk themes widgets
#
#
...
class SimpleDialog:
    ...
    def __init__(self, master,
        ...
        for num in range(len(buttons)):
            ...
            if num == default:
                pass
                # not compatible with ttk widget
...
if __name__ == '__main__':
    ...
    def test():
        ...
        t = ttk.Button(root, text='Test', command=doit)
        t.pack()
        q = ttk.Button(root, text='Quit', command=t.quit)
        q.pack()
        t.mainloop()
